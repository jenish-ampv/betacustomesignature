...
define('CONSUMER_KEY', '0iikTNzk6rw2y2e3oiZEd1CJo'); // Replace with your API key
define('CONSUMER_SECRET', 'lKfUuvnTXePsZAot6cgGqim6qomzY3Oe1lNiGDnkH3FfBylbLZ'); // Replace with your API secret key
define('OAUTH_CALLBACK', $GLOBALS['ROOT_LINK'].'x-login/callback.php'); // Replace with your callback URL																		  getting the data																	  getting the data
