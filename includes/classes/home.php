	...
	private function GetUserProfilePic(){
		if(is_numeric($GLOBALS['USERID'])){
			...
			if($usrRes['user_image'] != 'default.png' ){
				...
				$GLOBALS['USERPROFILEIMG'] = '<div class="size-[35px] md:size-8 rounded-full overflow-hidden text-white flex items-center justify-center"><img class="w-full h-full object-cover" src="'.$profile_img.'?'.time().'" alt=""></div>';
			}else{
