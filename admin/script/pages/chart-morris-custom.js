...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#47cfe0", "#536dfe", "#9ccc65"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffba57", "#ff5252", "#47cfe0"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#9ccc65', '#536dfe', '#47cfe0'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffba57', '#ff5252', '#47cfe0'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffba57', '#ff5252', '#47cfe0'],
            lineWidth: 2,
            hideHover: true
        });
